# Contributing to the Light SDK

> *Light's own file, kept here for reference after Amp forked the SDK. It
> governs [lightphone/light-sdk](https://github.com/lightphone/light-sdk),
> not this repository — see the root [CONTRIBUTING.md](../CONTRIBUTING.md) for Amp's.*


**The [code of conduct](light-sdk-CODE_OF_CONDUCT.md) applies to all contributions, please go check that out first.**
